...
object Dependencies {
  ...
  object Versions {
    ...
    val scalaTest           = "3.1.0"
    val scalaTestScalaCheck = s"$scalaTest.1"
  ...
  object Libraries {
    ...
    lazy val enumeratumCats      = enumeratum("enumeratum-cats")
    ...
    lazy val scalaTestScalaCheck  = "org.scalatestplus"     %% "scalacheck-1-14"            % Versions.scalaTestScalaCheck
